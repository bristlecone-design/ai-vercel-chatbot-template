...
export function StandardHeader({ className }: { className?: string }) {
  return (
    <header
      className={cn(
        'sticky top-0 z-20 flex min-h-14 items-center justify-between gap-2 px-2 py-1.5 backdrop-blur-md sm:w-full sm:bg-background/5 sm:backdrop-blur-sm md:px-2',
        className
      )}
    >
