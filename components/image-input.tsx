...
import { ACCEPTED_PHOTO_FILE_TYPES } from '@/features/photo';
import { clsx } from 'clsx';
import exifr from 'exifr';
import { FiUploadCloud } from 'react-icons/fi';

import { CopyExif } from '@/lib/exif';
import { blobToImage } from '@/lib/images';
import { MAX_IMAGE_SIZE } from '@/lib/next-image';
    ...
    <div className="min-w-0 space-y-4">
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        {showUploadStatus && filesLength > 0 && (
          <div className="max-w-full truncate">{uploadStatusText}</div>
        )}
      </div>
      <canvas
        ref={ref}
