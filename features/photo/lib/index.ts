import { formatFocalLength } from '@/features/focal';
import type { FilmSimulation } from '@/features/simulation';
import camelcaseKeys from 'camelcase-keys';
import { isBefore } from 'date-fns/isBefore';
import type { Metadata } from 'next';

import { formatDateFromPostgresString } from '@/lib/datesAndTimes';
import {
  formatAperture,
...
import { getNextImageUrlForRequest } from '@/lib/next-image';

import { ABSOLUTE_PATH_FOR_HOME_IMAGE } from '@/config/site-paths';
import { HIGH_DENSITY_GRID, SHOW_EXIF_DATA } from '@/config/site-settings';
import type { Photo, PhotoDb, PhotoDbInsert } from '@/types/photo';
