import { SITE_DOMAIN } from '@/lib/getBaseUrl';

import { parseAiAutoGeneratedFieldsText } from '@/features/photo/ai';
...
export const SITE_TITLE =
  process.env.NEXT_PUBLIC_SITE_TITLE || siteConfig.title;

export const SITE_DESCRIPTION =
  process.env.NEXT_PUBLIC_SITE_DESCRIPTION || SITE_DOMAIN;

// STORAGE: DATABASE
export const HAS_DATABASE = (process.env.POSTGRES_URL ?? '').length > 0;
export const POSTGRES_SSL_ENABLED = process.env.DISABLE_POSTGRES_SSL === '1';
// STORAGE: VERCEL KV
export const HAS_VERCEL_KV = (process.env.KV_URL ?? '').length > 0;
